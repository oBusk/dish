...
printf "Sep=;
DNS Ip; DNS Organization; whoami 'ns'; ns location; ns distance; whoami 'ecs'; whoami 'ip'; Akamai Edge; Akamai Edge Location; Akamai Edge Distance; Akamai Edge Pretransfer
$(sort -t ";" -k11 -n <<<$RESULT)
"
